...
- s3 (Envia Alto):Aguarda um período de espera após o atraso de nível baixo para permitir que o sensor DHT11 libere o barramento de dados.Após o período de espera 20 a 40 µs, transita para o estado s4.Se o período de espera não for alcançado, permanece nesse estado.
